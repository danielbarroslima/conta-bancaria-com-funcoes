...
while True:
	...
	if option.lower() == 'd':
		''
		account_movements, balance = deposit_account(option=option, balance=balance)
		...
		extract_account(account_movements=account_movements, option=option, balance=balance)
	elif option.lower() == 'q':
		break
	else:
